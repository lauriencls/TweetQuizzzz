...
public class TweetquizzzzServlet extends HttpServlet {
	...
	/*
	 * Rï¿½cupï¿½ration des tweets d'un compte donnï¿½ via l'API de Twitter et enregistrement dans le dataStore
	 * @param String playerName : Nom du compte Twitter du joueur
	 * @return ArrayList<Tweet> listeTweets : Tweets rï¿½cupï¿½rï¿½s et stockï¿½s
	 */
				...
				for (long id : ids.getIDs()) {
						...
						for (Status status : lesStatuts) {
							...
							if (entities.isEmpty()) {
								...
								tweet.setProperty("IsAlreadyPlayed", false); //La question a dÃ©jÃ  Ã©tÃ© posÃ©e
